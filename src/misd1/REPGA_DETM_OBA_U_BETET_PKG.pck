...
--                L_S_ZAROLT(X),
   ...
   BEGIN
    ...
    DELETE FROM REPGA_DETM_OBA_U_BETET
     WHERE RNO = 0;
    --
    INSERT INTO REPGA_DETM_OBA_U_BETET (CLIENT_NO, SZLA, UGYLET, TIPUS, BJOGCIM, EGYENLEG, KAMAT, FORRASADO, ZAROLT)
      SELECT CLIENT_NO, SZLA, UGYLET, TIPUS, BJOGCIM, EGYENLEG, KAMAT, FORRASADO, ZAROLT
