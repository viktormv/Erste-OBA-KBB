...
CREATE OR REPLACE PACKAGE BODY REPGA_STAM_OBA_BJEGY_PKG IS
  ...
  GC_TARGETTABLE CONSTANT VARCHAR2(30) := 'REPGA_EXTM_OBA_BJEGY';

  GC_SOURCETABLE CONSTANT VARCHAR2(30) := 'REPGA_EXTM_OBA_BJEGY';

  GC_CSVDIR CONSTANT VARCHAR2(200) := 'DIR_FROMBETETI_TOOBA.SQL';
  ...
  BEGIN
    ...
    G_CSVNAME := '\'||L_SYM_RUN_DATE||'\'||GC_CSVNAME||L_SYM_RUN_DATE;
