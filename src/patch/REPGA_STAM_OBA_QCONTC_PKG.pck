...
CREATE OR REPLACE PACKAGE BODY REPGA_STAM_OBA_QCONTC_PKG IS
  ...
  --   0.2 Vincze Csaba        GC_TARGETTABLE javitas
  --   0.2 Vincze Csaba        GC_CSVNAME modositas
  
  GC_APPNAME CONSTANT VARCHAR2(30) := 'REPGA_STAM_OBA_QCONTC_PKG';

  GC_TARGETTABLE CONSTANT VARCHAR2(30) := 'REPGA_STAM_OBA_QCONTC';

  GC_CSVNAME CONSTANT VARCHAR2(50) := 'OBA_CLIENT.csv';
