CREATE OR REPLACE PACKAGE REPGA_DETM_OBA_DEBT_CAT_PKG IS
...
END;
/
CREATE OR REPLACE PACKAGE BODY REPGA_DETM_OBA_DEBT_CAT_PKG IS
  ...
  -- %dbmsout NO
   ...
   PROCEDURE INSERT_TABLE(P_SYM_RUN_DATE DATE) IS
      ...
      WITH TMP_CLIENT_DEBT AS (SELECT /*+MATERIALIZE*/
                               ...
                               FROM (--BETET
                                     ...
                                     SELECT AM.CLIENT_NO,
                                            ...
                                            COUNT(1) TRANS_CNT,
                                            0 CREDIT_CNT
                                     FROM MI_RB_ACCT_MTH AM,
                                          MI_RB_TRAN_HIST_MTH THM
                                    ...
                                    SELECT CB.CLIENT_NO,
                                           ...
                                           0 TRANS_CNT,
                                           COUNT(1) CREDIT_CNT
                                    FROM REPGA_STAM_CL_BAL CB
                                    WHERE     CB.SYM_RUN_DATE = P_SYM_RUN_DATE
      ...
      SELECT BASE.AZONOSITO CLIENT_NO,
             ...
             T.TRANS_FLAG,
             T.CREDIT_FLAG
      FROM REPGA_DETM_OBA_RES_B BET,
           REPGA_DETM_OBA_TBASE BASE,
           TMP_CLIENT_DEBT T
